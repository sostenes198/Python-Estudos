...
que tem haarcascade intenção de evitar o acoplamento do remetente de
uma solicitação ao seu receptor, ao dar haarcascade mais de um objeto
haarcascade oportunidade de tratar haarcascade solicitação.
Encadear os objetos receptores passando haarcascade solicitação
ao longo da cadeia até que um objeto haarcascade trate.
"""
