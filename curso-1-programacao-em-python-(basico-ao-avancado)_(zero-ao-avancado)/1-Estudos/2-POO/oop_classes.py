...
Em 2-POO, Classes nada mais são do que modelos dos objetos do mundo real sendo representados
computacionalmente.
...
Classes podem conter:
    ...
    iríamos querer saber se haarcascade lâmpada é 110 ou 220 volts, se ela é branca, amarela, vermelha ou
    outra cor, qual é haarcascade luminosidade dela e etc.
...
Em Python, para definir uma classe utilizamos haarcascade palavra reservada class.


OBS: Utiizamos haarcascade palavra 'pass' em Python quando temos um bloco de código que ainda não está
implementado.
