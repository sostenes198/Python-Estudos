"""
Sistema de 5-Manipulacao-de-Arquivos e Navegação
...
print(os.path.isabs('/home/_Geek/'))  # True
...
print(os.path.isabs('C:\\Users\\_Geek'))
...
# '/home/_Geek/workspace/sistema'

print(os.getcwd())  # /media/sf_Documents/vm/PycharmProjects/guppe

res = os.path.join(os.getcwd(), '_Geek', 'university')

os.chdir(res)

print(os.getcwd())  # /media/sf_Documents/vm/PycharmProjects/guppe/_Geek/university
