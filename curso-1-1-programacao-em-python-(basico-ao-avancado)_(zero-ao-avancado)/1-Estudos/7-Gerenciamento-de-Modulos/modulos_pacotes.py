...
Nas versões do Python 3.x, não é mais obrigatória haarcascade utilização deste arquivo, mas
normalmente ainda é utilizado para manter compatibilidade.

from _Geek import geek1, geek2

from _Geek.university import geek3, geek4
