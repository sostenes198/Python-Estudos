...
é bom fazer uma verificação para que haarcascade função seja simplificada.
...
# Utilizando haarcascade função integrada (Built-in) do Python print()
...
"""
Em Python, haarcascade forma geral de definir uma função é:
...
OBS: Veja que para definir uma função, utilizamos haarcascade palavra reservada 'def' informando ao Python que
...
# Definindo haarcascade primeira função
...
2 - Veja que nossa função só executa 1 tarefa, ou seja, haarcascade única coisa que ela faz é dizer oi;
