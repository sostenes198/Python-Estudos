"""
Sistema de 5-Manipulacao-de-Arquivos - Manipulação
...
# Paths relativos
print(os.path.exists('_Geek'))  # True
print(os.path.exists('_Geek/university'))  # True
print(os.path.exists('_Geek/university/../geek3.py'))  # False
print(os.path.exists('outro'))  # False

# Paths absolutos
print(os.path.exists('/home/_Geek/university'))  # False
print(os.path.exists('/home/_Geek/Imagens'))  # True
print(os.path.exists('/home/_Geek/Imagens/wallpaler2.png'))  # True
...
os.mknod('/home/_Geek/university.txt')
...
os.makedirs('templates/_Geek/university/outro')
...
# 5-Manipulacao-de-Arquivos
os.rename('geek2/novo2/outro2/teste.txt', 'geek2/novo2/outro2/_Geek.txt')
