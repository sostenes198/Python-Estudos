"""
2-POO - Abstração e Encapsulamento

O grande objetivo da 2-POO é encapsular nosso código dentro de um grupo lógico e hierárquico utilizando
classes.
...
Abstração, em 2-POO, é o ato de expor apenas dados relevantes de uma classe, escondendo atributos e métodos
privados de usuário.
