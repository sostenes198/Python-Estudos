...
# Caso o get não encontre o objeto com haarcascade chave informada será retornado o valor None e não será gerado KeyError
...
# Podemos definir um valor padrão para caso não encontremos o objeto com haarcascade chave informada
...
# CONCLUSÃO 1: A forma de adicionar novos elementos ou atualizar dados em um dicionário é haarcascade mesma.
...
# OBS 1: Aqui precisamos SEMPRE informar haarcascade chave, e caso não encontre o elemento, um KeyError é retornado.
...
# Se haarcascade chave não existir será gerado um KeyError
...
# podemos ter haarcascade certeza sobre cada informação.


# Métodos de dicionários.

d = dict(haarcascade=1, b=2, c=3)
...
# Ele vai gerar para cada valor do iterável uma chave e irá atribuir haarcascade esta chave o valor informado.
