...
para haarcascade extensão de funcionalidades.
Decorator (padrão de projeto) != Decorator em Python
Python decorator -> Um decorator é um callable que aceita outra
função como argumento (haarcascade função decorada). O decorator pode
realizar algum processamento com haarcascade função decorada e devolvê-la
