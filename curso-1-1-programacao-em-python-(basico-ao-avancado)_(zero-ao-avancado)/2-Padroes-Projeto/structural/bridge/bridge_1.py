...
tem haarcascade intenção de desacoplar uma abstração
...
Geralmente, haarcascade abstração não faz nenhum trabalho
por conta própria, ela delega parte ou todo o
trabalho para haarcascade camada de implementação.
RELEMBRANDO: Adapter é um padrão de projeto
estrutural que tem haarcascade intenção de permitir
