...
solicitações), um ou vários objetos de comando (que fazem haarcascade ligação entre o
receiver e haarcascade ação haarcascade ser executada) e um receiver (o objeto que vai executar haarcascade
ação no final).
"""
