# PyPDF2 para manipular arquivos PDF (Instalação)# PyPDF2 é uma biblioteca de manipulação de arquivos PDF feita em Python puro,
...
RELATORIO_BACEN = PASTA_ORIGINAIS / 'R20230331.pdf'
...
files = [PASTA_NOVA / 'page1.pdf', PASTA_NOVA / 'page0.pdf', ]
